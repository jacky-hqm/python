...
if __name__ == "__main__":
    image = Image.open(r"C:\Users\hutao\Desktop\model_save\001.jpg")
    pp = []
    pp = eye_features(r'C:\Users\hutao\Desktop\model_save\001.jpg')
    leftx = pp[0][0]
    lefty = pp[0][1]
    rightx =pp[1][0]
    righty =pp[1][1]
    print(leftx,lefty,rightx,righty)
    CropFace(image, eye_left=(leftx, lefty), eye_right=(rightx, righty)).save("change.jpg")
